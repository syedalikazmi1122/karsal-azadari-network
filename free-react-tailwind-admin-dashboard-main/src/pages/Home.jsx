...
function Home() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative">
      ...
      <Link to="/admin">
        <button
          className="absolute top-6 right-8 px-5 py-2 rounded-xl bg-gradient-to-r from-purple-600 to-gold-400 shadow-lg text-white font-semibold hover:from-gold-400 hover:to-purple-600 transition-all duration-300 border-2 border-gold-400 z-10"
        >
          Admin
        </button>
      </Link>
      ...
      <div className="relative z-10 max-w-7xl mx-auto p-6">
        ...
        {/* Search & Filter */}
        <div className="mb-12 backdrop-blur-lg bg-white/10 rounded-3xl p-8 border border-white/20 shadow-2xl">
          <div className="flex flex-col lg:flex-row gap-6 items-center">
            <div className="relative flex-1 w-full">
              <input
                ...
                className="w-full p-4 pl-12 bg-white/20 backdrop-blur-sm border border-white/30 rounded-2xl text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-gold-400 transition-all duration-300 hover:bg-white/25"
              />
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none bg-white/20 backdrop-blur-sm border border-white/30 rounded-2xl px-6 py-4 pr-12 text-white focus:outline-none focus:ring-2 focus:ring-gold-400 transition-all duration-300 hover:bg-white/25 cursor-pointer"
              >
      ...
      <style jsx>{`
        ...
        .ring-gold-400 { --tw-ring-color: #fbbf24; }
        .border-gold-400 { border-color: #fbbf24; }
        .from-gold-400 { --tw-gradient-from: #fbbf24; }
        .via-gold-400 { --tw-gradient-via: #fbbf24; }
        .to-gold-400 { --tw-gradient-to: #fbbf24; }
      `}</style>
    </div>
  );
}
